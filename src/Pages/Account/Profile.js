      ...
      <div className="container py-4">
        ...
        <div className="d-flex">
          ...
          {accoutType === "Recruiter" ? (
            <div className="cid-box container mx-4 py-4">
                ...
                <div>
                  <div className="d-flex align-items-center">
                    {selectedImage ? (
                      ...
                      <img
                        className="rounded-circle bg-secondary m-4"
                  ...
                  <p className="shadow-sm my-4">{aboutCompany} </p>
                  <div class="row my-2">
                  ...
                  <div>
                    ...
                    <form className="bodyAll mt-3">
                      <div className="d-flex justify-content-between">
                        ...
                        <div className="input-box my-2">
                          <label className="cid-label">Your Designation</label>
                          <input
                            type="text"
                            className="form-control"
                            required
                      ...
                      <div className="d-flex justify-content-between">
                        <div className="input-box my-2">
                          <label className="cid-label">website</label>
                          <input
                            type="email"
                            className="form-control"
                            required
                        ...
                        <div className="input-box my-2">
                          <label className="cid-label">Address</label>
                          <input
                            type="phone"
                            className="form-control"
                            required
                      ...
                      <div className="d-flex justify-content-between">
                        ...
                        <div className="input-box my-2">
                          <label className="cid-label">Domain</label>
                          <input
                            type="text"
                            className="form-control"
                            required
                      ...
                      <div className="my-2">
                        <label className="cid-label">About Company</label>
                        <textarea
                          className="form-control"
                          style={{ height: "150px" }}
                          rows="4"
