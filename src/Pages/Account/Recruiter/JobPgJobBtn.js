...
function JobBtn() {
  ...
  async function showJobs() {
    ...
    try {
      const response = await fetch(
        `https://api-connectingids.vercel.app/getJob/${recruiterId}`,
        {
          method: "GET",
          headers: {
  ...
  async function saveJobData() {
    try {
      ...
      console.warn(data);
      const response = await fetch(
        "https://api-connectingids.vercel.app/createJob",
        {
          method: "POST",
          headers: {
            Accept: "application/json",
    ...
    <div className="job-body">
      {!jobForm && (
        <div className="my-4 d-flex justify-content-start flex-wrap">
          ...
          <div
            className="cid-box bg-primary m-3 p-2"
            onClick={showJobForm}
      ...
      {jobForm && (
        <div className="cid-box p-4 my-2">
          <form>
            <h2>Create a Job</h2>
            <div className="input-box my-4 w-100">
