  ...
  async function getAppliedCandidate() {
    try {
      const response = await fetch(
        `https://api-connectingids.vercel.app/candidatesWhoHasAppliedToJob/651a792d1fc15a18afc504dc`,
        {
          method: "GET",
          headers: {
    ...
    <div className="job-body my-4 ">
      ...
      >
        <div className={activeLayout === "grid" ? "w-75 me-3" : "w-100 me-3"}>
          <div className="d-flex">
            ...
            <div className="dropdown">
              <button
                className="btn-secondary-cidblue mx-2 p-1  "
                style={{ width: "100px" }}
                type="button"
              ...
              <div className="dropdown">
                ...
                >
                  {availableFields.map((header) => (
                    <div key={header} className="form-check my-1">
                      <input
                        type="checkbox"
                        id={header}
        ...
        <div className="w-25 ">
          {activeLayout === "grid" ? (
            <div>
              <div className="cid-box px-3 py-2">
                <h6>sort</h6>
