...
function LandingPage() {
  ...
  async function showAllJobs() {
    try {
      const response = await fetch(
        `https://api-connectingids.vercel.app/getAllJobs`,
        {
          method: "GET",
          headers: {
            Accept: "application/json",
  ...
  async function Apply(jobDataId) {
    try {
      ...
      const response = await fetch(
        `https://api-connectingids.vercel.app/jobApply/${candidateId}`,
        {
          method: "POST",
          headers: {
            Accept: "application/json",
      ...
      <div className="body tw-z-10">
        ...
        <div className="data-body">
          ...
          <div className="candidates h-100">
            <div className="flex-wrap my-2 d-flex justify-content-start">
